...
TermsPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'page-terms',template:/*ion-inline-start:"/home/phauser/Development/refersquare/rs-business-connectors/src/pages/terms/terms.html"*/'<ion-header>\n  <ion-navbar>\n    <div class="ion-title">Terms of Service</div>\n    <button ion-button icon-only menuToggle>\n      <ion-icon name="menu"></ion-icon>\n    </button>\n  </ion-navbar>\n</ion-header>\n<ion-content>\n  <div\n    class="mine"\n    [innerHTML]="tos | safeHtml"\n  ></div>\n</ion-content>\n'/*ion-inline-end:"/home/phauser/Development/refersquare/rs-business-connectors/src/pages/terms/terms.html"*/
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* NavController */],
...
var GlobalStorage = (function () {
    function GlobalStorage() {
        ...
        this.primaryDomain = 'http://bc.zweck.software:4000';
...
ForgotPasswordPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'page-forgot-password',template:/*ion-inline-start:"/home/phauser/Development/refersquare/rs-business-connectors/src/pages/forgotPassword/forgotPassword.html"*/'<ion-header></ion-header>\n\n<ion-content city-bg>\n  <div class="logo">\n    <img src="assets/imgs/catex-logo.png">\n    <p>The professional referral app</p>\n  </div>\n\n    <!-- form -->\n  <form\n    method="post"\n    novalidate=""\n    (ngSubmit)="submit()"\n    name="form.loginForm"\n    #form="ngForm"\n  >\n\n    <input\n      type="email"\n      name="email"\n      [(ngModel)]="auth.email"\n      placeholder="Email Address"\n      required\n      [email]="true"\n      #email="ngModel"\n    />\n\n    <div role="alert" *ngIf="email.invalid && (email.dirty || email.touched)">\n      <div *ngIf="email.errors.required" class="error">Please enter a value for this field.</div>\n      <div *ngIf="email.errors.email" class="error">This field must be a valid email address.</div>\n    </div>\n\n\n    <button\n      class="submit-button"\n      type="submit"\n      ng-disabled="!connection.online"\n    >\n      Submit\n    </button>\n\n    <div\n      *ngIf="form_error"\n      class="error"\n    >\n      {{form_error}}\n    </div>\n\n    <a\n      (click)="goBack()"\n      class="transparent-rounded-button"\n    >\n      cancel\n    </a>\n  </form>\n\n</ion-content>\n'/*ion-inline-end:"/home/phauser/Development/refersquare/rs-business-connectors/src/pages/forgotPassword/forgotPassword.html"*/
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* NavController */],
        __WEBPACK_IMPORTED_MODULE_3__services_globalstorage_globalstorage__["a" /* GlobalStorage */],
        __WEBPACK_IMPORTED_MODULE_4__angular_http__["b" /* Http */],
...
ForgotPasswordThanksPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'page-forgot-password-thanks',template:/*ion-inline-start:"/home/phauser/Development/refersquare/rs-business-connectors/src/pages/forgotPasswordThanks/forgotPasswordThanks.html"*/'<ion-header></ion-header>\n\n<ion-content city-bg>\n  <div class="logo">\n    <img src="assets/imgs/catex-logo.png">\n    <p>The professional referral app</p>\n  </div>\n\n\n  <h4 class="title">We have just emailed you a password reset</h4>\n\n  <h5 class="text">Follow the link to reset your password and get back to adding referrals!</h5>\n\n  <a\n    (click)="goBack()"\n    class="transparent-rounded-button"\n  >\n    Back to Login\n  </a>\n\n</ion-content>\n'/*ion-inline-end:"/home/phauser/Development/refersquare/rs-business-connectors/src/pages/forgotPasswordThanks/forgotPasswordThanks.html"*/
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* NavController */]])
...
LeadHistoryFiltersPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'page-lead-history-filters',template:/*ion-inline-start:"/home/phauser/Development/refersquare/rs-business-connectors/src/pages/leadHistoryFilters/leadHistoryFilters.html"*/'<ion-header>\n  <ion-navbar>\n    <div class="ion-title">Filter</div>\n    <button ion-button icon-only menuToggle>\n      <ion-icon name="menu"></ion-icon>\n    </button>\n  </ion-navbar>\n</ion-header>\n<ion-content>\n\n  <form\n    (ngSubmit)="submit(form)"\n    novalidate\n    name="form.paypalForm"\n    id="paypal-form"\n    #form="ngForm"\n  >\n    <ion-list\n      radio-group\n      [(ngModel)]="status"\n      name="status"\n    >\n      <ion-item>\n        <ion-label>Display ALL</ion-label>\n        <ion-radio value="0"></ion-radio>\n      </ion-item>\n      <ion-item>\n        <ion-label>Pending</ion-label>\n        <ion-radio value="1"></ion-radio>\n      </ion-item>\n      <ion-item>\n        <ion-label>Won</ion-label>\n        <ion-radio value="2"></ion-radio>\n      </ion-item>\n      <ion-item>\n        <ion-label>Lost</ion-label>\n        <ion-radio value="3"></ion-radio>\n      </ion-item>\n    </ion-list>\n\n    <button\n      class="submit-button"\n      type="submit"\n      ng-disabled="!connection.online"\n      style="margin-top: 20px"\n    >\n      Update\n    </button>\n  </form>\n\n</ion-content>\n'/*ion-inline-end:"/home/phauser/Development/refersquare/rs-business-connectors/src/pages/leadHistoryFilters/leadHistoryFilters.html"*/
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* NavController */],
        __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* NavParams */]])
...
WithdrawalHistoryFiltersPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'page-withdrawal-history-filters',template:/*ion-inline-start:"/home/phauser/Development/refersquare/rs-business-connectors/src/pages/withdrawalHistoryFilters/withdrawalHistoryFilters.html"*/'<ion-header>\n  <ion-navbar>\n    <div class="ion-title">Select Date Range</div>\n    <button ion-button icon-only menuToggle>\n      <ion-icon name="menu"></ion-icon>\n    </button>\n  </ion-navbar>\n</ion-header>\n<ion-content>\n\n  <form\n    (ngSubmit)="submit(form)"\n    novalidate\n    name="form.paypalForm"\n    id="paypal-form"\n    #form="ngForm"\n  >\n    <ion-list\n      radio-group\n      [(ngModel)]="date_range_id"\n      name="date_range_id"\n    >\n      <ion-item>\n        <ion-label>This Week</ion-label>\n        <ion-radio value="1"></ion-radio>\n      </ion-item>\n      <ion-item>\n        <ion-label>This Month</ion-label>\n        <ion-radio value="2"></ion-radio>\n      </ion-item>\n      <ion-item>\n        <ion-label>3 Months</ion-label>\n        <ion-radio value="4"></ion-radio>\n      </ion-item>\n      <ion-item>\n        <ion-label>This Year</ion-label>\n        <ion-radio value="3"></ion-radio>\n      </ion-item>\n      <ion-item>\n        <ion-label>ALL Time</ion-label>\n        <ion-radio value="5"></ion-radio>\n      </ion-item>\n    </ion-list>\n\n    <button\n      class="submit-button"\n      type="submit"\n      ng-disabled="!connection.online"\n      style="margin-top: 20px"\n    >\n      Update\n    </button>\n  </form>\n\n</ion-content>\n'/*ion-inline-end:"/home/phauser/Development/refersquare/rs-business-connectors/src/pages/withdrawalHistoryFilters/withdrawalHistoryFilters.html"*/
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* NavController */],
        __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* NavParams */]])
...
WithdrawThanksPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'page-withdraw-thanks',template:/*ion-inline-start:"/home/phauser/Development/refersquare/rs-business-connectors/src/pages/withdrawThanks/withdrawThanks.html"*/'<ion-header>\n  <ion-navbar>\n    <div class="ion-title">Thank you</div>\n    <button ion-button icon-only menuToggle>\n      <ion-icon name="menu"></ion-icon>\n    </button>\n  </ion-navbar>\n</ion-header>\n\n<ion-content>\n  <div class="logo">\n    <img src="assets/imgs/catex-logo-dark.png">\n  </div>\n\n\n  <div class="header1">Thank you</div>\n  <div class="header2">\n    Your withdrawal request has been receeved\n  </div>\n  <div class="header3">\n    We will credit your account as soon as possible. Please not this may take up to 7 working days.\n  </div>\n\n  <div class="bottom">\n    <a\n      class="transparent-rounded-button small"\n      (click)="goToDashboard()"\n    >\n      Back to Dashboard\n    </a>\n    <a\n      class="transparent-rounded-button small"\n      (click)="goToReferralsPage()"\n    >\n      Track Referrals\n    </a>\n  </div>\n</ion-content>\n'/*ion-inline-end:"/home/phauser/Development/refersquare/rs-business-connectors/src/pages/withdrawThanks/withdrawThanks.html"*/
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* NavController */]])
], WithdrawThanksPage);
...
MyApp = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({template:/*ion-inline-start:"/home/phauser/Development/refersquare/rs-business-connectors/src/app/app.html"*/'<ion-nav [root]="rootPage"></ion-nav>\n'/*ion-inline-end:"/home/phauser/Development/refersquare/rs-business-connectors/src/app/app.html"*/
    }),
